      ...
      <div class="card">
        ...
        <form method="POST" action="{{ route('login') }}" novalidate>
          ...
          <div class="row">
            ...
            <input id="identifier" class="ctrl @error('identifier') is-invalid @enderror"
                   type="text" name="identifier" placeholder="email@contoh.com atau username"
          ...
          <div class="row">
            ...
            <div class="input-group">
                <input id="pwd" class="ctrl @error('password') is-invalid @enderror"
                       type="password" name="password" placeholder="Password" required autocomplete="current-password" minlength="6">
        ...
        <div class="foot">
          Belum punya akun? <a href="{{ route('pelanggan.register') }}">Daftar</a>
        </div>
      </div>
    </div>
  </div>
